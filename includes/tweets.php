...
if (isset($_POST['updatTweet'])) {
    ...
    $editTweet = $_POST['editTweet'];

    Tweet::updateTweet($tweetId, $editTweet );
    // header('location:home.php');
}
foreach($tweets as $tweet) { 
              ...
              if ($retweet->retweet_id == null) {
                  ...
                  $retweeted_tweet = Tweet::getRetweet($retweet->retweet_id);
                      ...
                      if($retweeted_tweet->tweet_id != null) {
                          ...
                          $user_inner_tweet = Tweet::getData($tweet_inner->user_id) ;
                          $timeAgo_inner = Tweet::getTimeAgo($tweet_inner->post_on);
      ...
      ?>
              ...
              <p class="tweet-links" id="tweet-<?php echo $tweet->id ?>">
                 <?php
              ...
              <form method="POST" class="d-none" id="edit-tweet-<?php echo $tweet->id?>">
                        <input class="d-none" type="number" name="tweetId"
                  ...
                  <div class="dropdown" >
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                      <button class="dropdown-item" onclick="editTweet( <?php echo $tweet->id ?>)" type="button"><i class="fas fa-pencil-alt icon" aria-hidden="true"></i> Edit</button>
                                ...
                                <button class="dropdown-item"  name="deleteTweet" onclick="return confirm('Are you sure?')" type="submit">
...
function editTweet(tweetId){
    ...
    const data = document.getElementById('tweet-'+tweetId).innerText;
