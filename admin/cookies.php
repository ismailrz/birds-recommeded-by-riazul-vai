                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="mb-0"> <strong>Cookies</strong></h4>
                                </div>
                                <div class="card-body">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo $sl++  ?> </td>
                                                <td><?php echo substr($result->cookies, 0, 300)  ?>... </td>

                                                <td> <a href="cookiesUpdate.php?id=<?php echo $result->id ?>">
                                                        <button title="update cookies"
