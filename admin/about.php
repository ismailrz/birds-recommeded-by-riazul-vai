                                ...
                                <div class="card-body">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo $sl++  ?> </td>
                                                <td><?php echo substr($result->description, 0, 300)  ?>... </td>

                                                <td> <a href="aboutUpdate.php?id=<?php echo $result->id ?>">
                                                        <button title="about us" class="btn btn-warning btn-sm me-1"> <i
