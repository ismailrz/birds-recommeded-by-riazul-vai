  ...
  <div  class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>This is YROBS is developed by Yrobs opc pvt ltd <span style="font-weight: 700;"> YROBS </span>  for learning purpose.</p>
        ...
        <p>By default you followed
          <a style="color:#207ce5;" href="codeastro">santosh444gmail.com</a> 
    ...
    <div class="wrapper-left">
      ...
      <div class="grid-posts">
                        ...
                        <div class="bottom"> 
                         ...
                         <?php } } unset($_SESSION['errors_tweet']); ?>
                          <div>
                            ...
                            <input id="tweet-input" type="submit" name="tweet" value="Bird" class="submit"
                            >
                          </div>
                      </div>
                      </form>
        ...
        <div class="wrapper-right">
          ...
          <input type="text" class="form-control search-input"  placeholder="Search Bird">
